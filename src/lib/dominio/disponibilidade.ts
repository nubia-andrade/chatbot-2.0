 ...
 * vencem regras comerciais; restrição cadastrada e concorrência tornam a data
 * inelegível para ESTE cliente; esgotamento é avaliado depois porque é uma
 * condição do inventário, não do anunciante. Data especial não muda o estado:
 * ela acompanha o resultado para a interface sinalizar preço diferenciado.
 */
