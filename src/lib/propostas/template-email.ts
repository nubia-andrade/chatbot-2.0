...
<div style="font-family:Arial,sans-serif;font-size:11px;line-height:16px;color:#ff826c;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Globo Slots</div>
...
<tr><td style="border-top:1px solid #eceef1;padding:18px 34px 22px 34px;font-family:Arial,sans-serif;font-size:10.5px;line-height:16px;color:#9aa0a8;">Proposta gerada no Globo Slots</td></tr>
