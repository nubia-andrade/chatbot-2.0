  ...
  return (
    <div className="relative mx-auto max-w-[1180px] px-5 pb-[70px] pt-[28px] sm:px-7">
      ...
      <div className="relative flex flex-wrap items-center gap-3.5">
        <div><p className="text-[11px] font-semibold uppercase tracking-[1.7px] text-[#ff5a3c]">Planejamento de oportunidades</p><h1 className="vitrine-pop mt-1 text-[30px] font-extrabold tracking-[-1px]">{MESES[mes]} {ano}</h1></div>
